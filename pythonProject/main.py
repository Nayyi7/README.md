...
covid_records = []
print("Values of covid_records:", covid_records)
print("Type of covid_records:", type(covid_records))
print("Size of covid_records:", len(covid_records))
...
# def tui_data_preprocessing_start ():
print("data preprocessing started")


def tui_data_preprocessing_complete():
    print("data preprocessing completed")


tui_data_preprocessing_complete()
...
# def  tui_data_visualization_start ():
print("data visualization operation has started")


def tui_data_visualization_done():
    print(" data visualization operation is to be done")


def tui_data_visualization_complete():
    print(" data visualization operation is completed")


tui_data_visualization_start()
tui_data_visualization_done()
tui_data_visualization_complete()
